...
export const TableS = () => {
  ...
  const rowStyle = {
    backgroundColor:
      (roomData.roomNb === 610 && cont1 === 4? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 616 && cont2 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 622 && cont3 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 625 && cont4 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 630 && cont5 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 631 && cont6 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 632 && cont7 === 4 ? 'rgba(0, 255, 0, 0.41)' :
