...
export const Departament2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:8082/sector2/getAll");
  ...
  const rowStyle = {
    backgroundColor:
      (roomData.roomNb === 201 && cont1 === 4? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 202 && cont2 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 203 && cont3 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 212 && cont4 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 216 && cont5 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 222 && cont6 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 223 && cont7 === 4 ? 'rgba(0, 255, 0, 0.41)' :
