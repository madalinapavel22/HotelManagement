...
export const Departament3 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://localhost:8082/sector3/getAll");
  ...
  const rowStyle = {
    backgroundColor:
      (roomData.roomNb === 301 && cont1 === 4? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 303 && cont2 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 305 && cont3 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 313 && cont4 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 316 && cont5 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 320 && cont6 === 4 ? 'rgba(0, 255, 0, 0.41)' :
      roomData.roomNb === 323 && cont7 === 4 ? 'rgba(0, 255, 0, 0.41)' :
